...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_layout_and_styling(self):
        ...
        # Ele percebe que a caixa de entrada está elegantemente centralizada
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## Usamos uma nova sessão do navegador par garantir que nenhuma informação Edith esa vindo de cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
